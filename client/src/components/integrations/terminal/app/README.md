# Stripe Terminal (Server-Driven) Demo

A minimal Express + vanilla JS app that demonstrates Stripe Terminal's server-driven integration.
...
8. Click "Create Simulated Reader" to begin the payment flow.
