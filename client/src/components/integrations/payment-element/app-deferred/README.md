# Stripe Payment Element Demo (Deferred)

A minimal Express + vanilla JS app that demonstrates Stripe's Payment Element using deferred PaymentIntent creation. The PaymentIntent is created on the server at confirmation time rather than on page load.
