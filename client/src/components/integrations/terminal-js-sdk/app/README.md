# Stripe Terminal (JavaScript SDK) Demo

A minimal Express + vanilla JS app that demonstrates Stripe Terminal's JavaScript SDK integration.
...
8. Click "Connect to Simulated Reader" to begin the payment flow.
