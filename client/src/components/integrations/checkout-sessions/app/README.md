# Stripe Elements + Checkout Sessions Demo

A minimal Express + vanilla JS app that demonstrates Stripe's Elements with the Checkout Sessions API (`ui_mode: 'custom'`).
